...
const Home = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState("/images/clear-sky.jpg"); // Default background
  ...
  return (
    <div className="flex h-[100vh] justify-center items-center flex-col">
      <p className="text-[30px] font-[600] mt-[-100px] gradient-text">
        Check <span className="text-[30px] gradient-text1">weather</span> in
        your city
      </p>
      <div className="flex justify-center items-center mr-5 ml-5 mt-[-50px]">
        ...
        >
          <div className="w-[640px] h-[440px] px-8 rounded-2xl flex justify-center items-center bg-gradient-to-tr text-white shadow-lg flex-col backdrop-blur-[6px] bg-white bg-opacity-20 sm:w-[390px] sn:w-auto mt-[50px]">
            ...
            {weather ? (
              <div className="mt-5 mb-[-130px] flex-row text-gray-900 justify-evenly mr-[80px] sm:mb-[-230px] sm:mr-2">
                ...
                <div className="grid grid-cols-2 gap-2 w-max text-[17px]">
                  ...
                  <p className="mr-2">
                    Max Temp: {weather.main.temp_max.toFixed(0)}&#176;C
                  </p>
                  <p>
                    Min Temp: {weather.main.temp_min.toFixed(0)}&#176;C
                  </p>
                </div>
              </div>
            ) : (
              <p className="mt-5">⚠️ No weather data available</p>
            )}
          </div>
        </form>
      </div>
